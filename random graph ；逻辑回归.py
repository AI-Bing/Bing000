...
#         xishu=np.exp(np.dot(xs,np.transpose(uim)))/((1+np.exp(np.dot(xs,np.transpose(uim))))**2)
...
plt.plot(x_axix[0:iter0:100],np.array(plt_loss_1/loss1)[0:iter0:100], color='green', label='DGD',marker='s')
plt.plot(x_axix[0:iter0:100],np.array(plt_loss_2/loss1)[0:iter0:100], color='m', label='EXTRA',marker='o')
plt.plot(x_axix[0:iter0:100],np.array(plt_loss_3/loss1)[0:iter0:100], color='orange', label='D-NG',marker='d')
plt.plot(x_axix[0:iter0:100],np.array(plt_loss_4/loss1)[0:iter0:100], color='blue', label='Acc-DNGD-SC',marker='^')
plt.plot(x_axix[0:iter0:100],np.array(plt_loss_5/loss1)[0:iter0:100], color='red', label='DHB',marker='*')
plt.legend() # 显示图例
plt.xlabel(r'$k$')
plt.ylabel('Residual')
plt.yscale('log')
plt.savefig('(a) Random graph（2）.eps', dpi=500, bbox_inches='tight')
plt.show()
